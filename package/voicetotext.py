...
#相关参考：https://www.xfyun.cn/doc/asr/voicedictation/API.html#%E6%8E%A5%E5%8F%A3%E8%AF%B4%E6%98%8E
...
def get_text_from_voice(path_api:str,file_path: str) -> str:
    ...
    #将字符进行拼接
    text_from_vocie = ''.join(text_result)

    return text_from_vocie
